...
async function main (params) {
  ...
  try {
    ...
    // map event name
    const mappedEventType = eventMappings[params.data?.event]

    // trim the event payload
    const transformedEventData = transformData(params)
    ...
    const eventType = mappedEventType ? mappedEventType: params.data.event
