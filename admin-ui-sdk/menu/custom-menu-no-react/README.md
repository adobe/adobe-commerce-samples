# Adobe Commerce Admin UI SDK - Custom Menu no React (Vanilla)

This application extends the Adobe Commerce Admin UI by adding a custom menu without REACT using the Admin UI SDK’s menu extension point.
...
- **Custom Menu**: Add new menu item that redirect to your App Builder application.
